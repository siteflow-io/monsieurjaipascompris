...
- [ ] **M-débat-mobile · Pilotage en cartes (passe de CONCEPTION, différée après le site)** 🟠 — exigence Paul 17/07 : « tout gérer sans scroll » sur téléphone. Le tableau de suivi de séance (6 colonnes × N groupes, 1100 px) est inutilisable en 390 px, même défilable. Cible : en mobile, le tableau se transforme en CARTES EMPILÉES (une carte par groupe, étapes en pastilles tappables), desktop garde son tableau. À cadrer à froid (quelles infos/actions par carte). NON bloquant : le débat est utilisable en classe sur grand écran.
