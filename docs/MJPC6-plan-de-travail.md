...
- [ ] **M5bis · Débat : les 10 documents au projet** 🟠 (courte, avant le premier débat réel de l'année) — migration des documents en dur vers `debats/<slug>/documents`, édition en Préparation (sous-onglet Documents), seed générique par défaut à la création (textes actuels dé-spécifiés, RELUS PAR PAUL — c'est son contenu), migration des débats existants, fallback seed embarqué (doctrine), principe 15 appliqué jusqu'au bout.
